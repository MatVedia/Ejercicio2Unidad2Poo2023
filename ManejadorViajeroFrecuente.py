                ...
                while opci != 'Z':
                    if opci == 'A':
                        ...
                        if not cantNuevasMillas.strip().isdigit():
                            ...
                            viajero.acumularMillas(int(cantNuevasMillas))
                    elif opci == 'C':
                        ...
                        if not cantidadACanjear.isdigit():
                            ...
                            cantidadActualDeMillas = viajero.canjearMillas(int(cantidadACanjear))
                            print('Su cantidad actual de millas es {}'.format(cantidadActualDeMillas))
                    else:
